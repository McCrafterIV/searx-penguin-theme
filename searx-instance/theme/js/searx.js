...
window.searx = (function(d) {
    ...
    const itemsToHideIfJsIsActive = d.getElementsByClassName('active_if_nojs');
    for (const itemToHideIfJsIsActive of itemsToHideIfJsIsActive) {
        itemToHideIfJsIsActive.parentElement?.removeChild(itemToHideIfJsIsActive);
    }
